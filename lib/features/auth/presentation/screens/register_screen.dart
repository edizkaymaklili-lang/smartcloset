    ...
    return Scaffold(
      body: Container(
        ...
        child: SafeArea(
          child: Column(
            children: [
              // ─── Scrollable top: avatar + form + terms ───
              Expanded(
                child: SingleChildScrollView(
                  ...
                  child: Column(
                    children: [
                      ...
                      const AnimatedFashionAvatar(height: 100),
                      const SizedBox(height: 8),
                      Text(
                        'Create Account',
                                ...
                                children: [
                                  ...
                                  TextSpan(
                                    ...
                                    recognizer: TapGestureRecognizer()
                                      ..onTap = () => _showLegalDoc(LegalTexts.termsOfServiceTitle, LegalTexts.termsOfService),
                                  ),
                                  ...
                                  TextSpan(
                                    ...
                                    recognizer: TapGestureRecognizer()
                                      ..onTap = () => _showLegalDoc(LegalTexts.privacyPolicyTitle, LegalTexts.privacyPolicy),
                                  ),
                                  const TextSpan(text: ', and consent to the processing of my personal data per the '),
                                  TextSpan(
                                    ...
                                    recognizer: TapGestureRecognizer()
                                      ..onTap = () => _showLegalDoc(LegalTexts.dataProcessingTitle, LegalTexts.dataProcessingNotice),
                                  ),
                                  const TextSpan(text: '.'),
                                ],
                              ),
                ...
                child: Column(
                  ...
                  children: [
                    ...
                    OutlinedButton.icon(
                      ...
                      label: const Text('Sign up with Google', style: TextStyle(fontSize: 15, fontWeight: FontWeight.w500)),
